class Pyinit < Formula
  ...
  on_macos do
    if Hardware::CPU.intel?
      url "https://github.com/Pradyothsp/pyinit/releases/download/v0.0.01-alpha/pyinit-darwin-amd64"
      sha256 "23c96e112899d4704ba994b743ab3c20abae10d5a5baf0d1e107251a8699c555"
    end
    if Hardware::CPU.arm?
      url "https://github.com/Pradyothsp/pyinit/releases/download/v0.0.01-alpha/pyinit-darwin-arm64"
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/Pradyothsp/pyinit/releases/download/v0.0.01-alpha/pyinit-linux-amd64"
